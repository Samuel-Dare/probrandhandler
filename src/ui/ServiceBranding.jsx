  ...
  return (
    <div className="px-5">
      <Style1
        ...
        l4="Brand Storytelling: Aiding SMEs in constructing impactful brand narratives that forge emotional connections with their audience"
        l5="Brand Management: Offering continuous brand management services to uphold consistency and relevance over time."
      />
    </div>
  );
}
